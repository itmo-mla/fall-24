...
class CustomRidge:
    ...
    def train(self, features, target, regularization=1.0):
        ...
        # Вычисляем скорректированные сингулярные значения с учетом регуляризации
...
# Поиск лучшего значения регуляризации
...
# Оценка производительности собственной реализации
...
# Оценка производительности модели из библиотеки scikit-learn
start_time = time.time()
